...
<body>
                ...
                <tbody>
                    <?php 
                       ...
                       for($i = 0; $i < count($users); $i++){
                           ...
                           echo "   <td>".$users[$i]['drzava']."</td>";
                           echo "   <td>".$users[$i]['grad']."</td>";
    ...
    <script>
        ...
        async function showEditModal(id){
            ...
            let response = await fetch("http://localhost/api/user.php?id="+id);
            ...
            if(responseJSON.status == true){
                ...
                document.getElementById("editModalLastName").value = userData.last_name;
                document.getElementById("editModalEmail").value = userData.email;
                document.getElementById("editModalDrzava").value = userData.drzava;
                document.getElementById("editModalGrad").value = userData.grad;
